                            ...
                            <div class="tab-pane fade" id="assignment-tab-pane" role="tabpanel" aria-labelledby="assignment-tab" tabindex="0">
                                ...
                                <div class="card shadow-sm px-3 py-3 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-1 col-sm-1 col-md-1">
                                            <div class="mt-2">
                                                <a href="{{ asset('trainee/tasks/'.$assign->file) }}" class="text-muted text-decoration-none mt-3" target="_blank"  role="button" >
                                                    <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-xs-1 col-sm-1 col-md-1">
                                            <div class="mt-2" style="cursor: pointer;">
                                                <a  onclick="$('#task_destroy').submit();"  class="text-muted text-decoration-none mt-3" >
                                                    <i class="fa fa-trash"></i>
                                                </a>
                                            </div>
                                            <form id="task_destroy" action="{{ route('assignments.destroy',$assign->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="card shadow-sm px-3 py-3 mb-4">
                                                    <form enctype="multipart/form-data" id="assignment_form" method="post" action="{{ route('assignments.store') }}">
                                                        @csrf
                                                        @method('POST')
