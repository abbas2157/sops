...
<div class="container-fluid pt-4 px-4 mb-5">
    <div class="border-bottom">
        <h3 class="all-adjustment pb-2 mb-0">All Tasks</h3>
    </div>
        ...
        <div class="card-header bg-white border-0 rounded-3">
            <div class="row my-3">
                ...
                <div class="col-md-8 col-12 text-end">
                    <a href="{{ route('trainer.batches.class',['batch' => request()->batch_id]) }}" class="btn rounded-3 mt-2 excel-btn"> Back to Batch List</a>
