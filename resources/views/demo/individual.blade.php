                    ...
                    <div class="col-md-6 col-12 py-5 px-4">
                        <div class="signup-form text-white my-5">
                            ...
                            <form class="signup-input" method="post" action="{{ route('register.perform') }}" autocomplete="off">
                                <div>
                                    <label>Do You have a company Voucher ? </label>
                                    <div class="row text-white keep-me-logged">
                                        <div class="col-md-2 d-flex mt-1">
                                            <input type="radio" class="checkboxing" name="voucher" id="voucher" value="yes" checked>
                                            <span>Yes</span>
                                        </div>
                                        <div class="col-md-6 d-flex mt-1">
                                            <input type="radio" class="checkboxing" name="voucher" id="voucher"  value="no" >
                                            <span>No</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="yes">
                                    <div class="password-container">
                                        <input type="text" name="name" class="form-control" placeholder="Voucher Code" required autocomplete="off"/>
                                    </div>
                                    <div class="password-container">
                                ...
                                <div class="no" style="display: none">
                                    ...
                                    <div class="mt-3">
                                        <label class="total">Total = $1500 </label>
                                    </div>
                                </div>
