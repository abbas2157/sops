...
<head>
    ...
    <title>Your Registration is Confirmed for the {{ $workshop->title ?? 'No Title' }}</title>
...
<body style="background-color: #e9ecef;">
    <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        Your Registration is Confirmed for the {{ $workshop->title ?? 'No Title' }}
    </div>
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            <p style="margin: 0;">Thank you for registering for the <b>{{ $workshop->title ?? 'No Title' }}</b> by the <b>School of Professional Skills!</b> We're excited to have you join us.</p>
                            <br>
                            ...
                            @else
                                <p>Please bring a printed or soft copy of this email for entry. If you have any questions or need further assistance, feel free to reach out.</p>
