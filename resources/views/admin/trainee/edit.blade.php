                                ...
                                <div class="col-md-6">
                                    <div class="form-group fw-bold">
                                        <label for="exampleFormControlSelect6">Date of Birth <span
                                                class="text-danger">*</span></label>
                                        <input type="date" name="date_of_birth" id="date_of_birth" class="form-control subheading mt-2" value="{{$trainee->trainee->date_of_birth}}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select subheading mt-1"
                                            ...
                                            <option value="{{ $trainee->trainee->city_from ?? ''}}">{{ $trainee->trainee->city_from ?? ''}}</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-select subheading mt-1"
                                            ...
                                            <option value="{{ $trainee->trainee->city_currently_living_in ?? ''}}">{{ $trainee->trainee->city_currently_living_in ?? ''}}</option>
                                            <option value="" disabled>Punjab Cities</option>
                                            <option value="Lahore">Lahore</option>
                                            <option value="Islamabad">Islamabad</option>
                                            <option value="Karachi">Karachi</option>
